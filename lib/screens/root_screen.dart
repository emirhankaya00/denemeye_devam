...
// Ekran importları\import 'package:denemeye_devam/screens/dashboard_screen.dart';
          ...
          PopupMenuButton<String>(
            ...
            itemBuilder: (context) => [
              ...
              PopupMenuItem<String>(
                ...
                child: Row(
                  children: [
                    Icon(Icons.notifications, color: AppColors.textColorDark),
                    const SizedBox(width: 8),
                    Text(
                      'Bildirimler',
                      style: AppFonts.bodyMedium(
    ...
    return AppBar(
      ...
      title: showSearchField
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            ...
            suffixIcon: _searchController.text.isNotEmpty
                ? IconButton(
              icon:
              Icon(Icons.clear, color: AppColors.textColorLight),
              onPressed: () {
                _searchController.clear();
        ...
        style: AppFonts.poppinsBold(
            fontSize: 20, color: AppColors.textOnPrimary),
      ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        elevation: 10,
        selectedLabelStyle:
        AppFonts.bodySmall(color: AppColors.textOnPrimary),
